...
class TestMain:
    ...
    def test_2(self):
        ...
        self.driver.find_element(By.XPATH, '//*[@id="app"]/div[2]/div/aside/nav[3]/menu/li[1]/div/div/div/div/a[6]/span[2]').click()
        self.driver.find_element(By.XPATH, '//html/body/section/div/div/div/div/div/div/div[1]/div/input').send_keys('task234')
        self.driver.find_element(By.XPATH, '//html/body/section/div/div/div/footer/button[2]').click()
    ...
    def test_8(self):
        ...
        self.driver.find_element(By.XPATH, '//*[@id="app"]/div[2]/div/main/div/div[2]/div/div/div/div/div/p[1]/textarea').send_keys('786')
        self.driver.find_element(By.XPATH, '//*[@id="app"]/div[2]/div/main/div/div[2]/div/div/div/div/div/p[2]/button/span[2]').click()
    ...
    def test_10(self):
        ...
        self.driver.find_element(By.XPATH, '//*[@id="app"]/header/button').click()
        self.driver.find_element(By.XPATH, '//*[@id="app"]/div[2]/div/aside/nav[3]/menu/li[3]/div/a/span[2]').click()
        self.driver.find_element(By.XPATH, '//*[@id="app"]/div[2]/div/main/div/div[2]/div/div/div/ul/div[1]/a').click()
        self.driver.find_element(By.XPATH, '//*[@id="app"]/div[2]/div/main/div/div/div[2]/div[1]/div[3]/div/div/div/div/div[1]/div/div[2]/div/div[2]/div[6]').send_keys('add a performer')
        self.driver.find_element(By.XPATH, '//*[@id="app"]/div[2]/div/main/div/div/div[2]/div[1]/div[3]/div/div[2]/div/div/div[2]/button').click()
    ...
    def test_13(self):
        ...
        self.driver.find_element(By.XPATH, '//*[@id="app"]/header/button').click()
        self.driver.find_element(By.XPATH, '//*[@id="app"]/div[2]/div/aside/nav[1]/menu/li[3]/a').click()
        self.driver.find_element(By.XPATH, '//*[@id="app"]/div[2]/div/main/div/header/div[2]/a[2]').click()
        self.driver.find_element(By.XPATH, '/html/body/section/div/div/div/div/div/div/div[1]/div/input').send_keys('Tests123')
        self.driver.find_element(By.XPATH, '/html/body/section/div/div/div/footer/button[2]').click()
    ...
    def test_addTask(self):
        self.driver.find_element(By.XPATH, '//*[@id="app"]/div[2]/div/main/div/div[1]/div/p[1]/textarea').send_keys('task')
        self.driver.find_element(By.XPATH, '//*[@id="app"]/div[2]/div/main/div/div[1]/div/p[2]/button').click()
